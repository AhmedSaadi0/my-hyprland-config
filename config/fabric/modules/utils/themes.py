...
dynamic_m3_light_theme = Theme(
    wallpaper=None,
    css_theme=None,
    wallpaper_path="/path/to/light/m3/wallpapers",  # Set your light M3 wallpaper path
    dynamic=True,
    interval=15 * 60 * 1000,
    gtk_mode="light",
    plasma_color="MateriaYaruDark.colors",  # Note: Using Dark Plasma Color for Light Theme as in original JS
    kvantum_theme="Arc",
    gtk_theme="Breeze",
    qt_icon_theme="BeautySolar",
    gtk_icon_theme="BeautySolar",
