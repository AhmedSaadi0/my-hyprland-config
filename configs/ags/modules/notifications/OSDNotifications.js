...
const Popups = () => Box({
    ...
    attribute: {
        ...
        'notify': (box, id) => {
            ...
            // box.attribute.map.delete(id);
            box.attribute.map.set(id, MyNotification(Notifications.getNotification(id)));
...
const OSDNotification = () => Box({
    ...
    .hook(Notifications, (box, id) => {
        ...
        box.children = [MyNotification(Notifications.getNotification(id)), ...box.children];
